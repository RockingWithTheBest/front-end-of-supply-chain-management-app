...
const RebuiltForm =()=>{
  ...
  const validationSchema = Yup.object({
    ...
    roleid: Yup.string().oneOf(["5323542","5323542","37546743"], "Role Id must be one of the specified values").required("Role Id is required"),
    ...
    const handleSubmit = async (e) => {
      ...
      try{
        ...
        try{
            fetch(`${API_URL}api/Customer/AddCustomer-With-RoleId?RoleId=${roleid}`,
                {
                    method: 'POST',
                    headers: {
       ...
       // console.error("Validation failed", err.inner);
       alert('An error occured while registering reload the page and try again ', error.message);
       const newErrors ={};
